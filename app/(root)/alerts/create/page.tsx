      ...
      <div className="w-full max-w-xl rounded-xl border border-gray-700 bg-[#141414] p-6 shadow-xl">
        ...
        <form action={createPriceAlertAction} className="space-y-5">
          ...
          <div>
            ...
            <input
              name="alertName"
              defaultValue={`${initialCompany || initialSymbol} at Target`}
          ...
          <div className="flex items-center gap-3 pt-2">
            <Link href={`/stocks/${initialSymbol}`} className="px-4 py-2 rounded-md bg-gray-800 text-gray-200 hover:bg-gray-700">Cancel</Link>
