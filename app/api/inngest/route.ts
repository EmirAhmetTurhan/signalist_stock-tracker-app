...
export const { GET, POST, PUT } = serve({
    client: inngest,
    functions: [sendSignUpEmail, sendDailyNewsSummary, evaluateDailyPriceAlerts, evaluateSmartAlerts, aiOptimizeParameter, aiRankIndicatorsJob, aiProcessChatMessage, evaluateForwardTestsDailyJob, evaluateForwardTests4HJob, evaluatePendingOrdersJob, processCorporateActionsJob],
})