...
interface DiscoveredStrategiesSectionProps {
    discoveredStrategies: SavedStrategyItem[];
...
export function DiscoveredStrategiesSection({
    ...
    startRename,
    handleDelete,
}: DiscoveredStrategiesSectionProps) {
    return (
        <div className="mb-3">
...
export default DiscoveredStrategiesSection;
