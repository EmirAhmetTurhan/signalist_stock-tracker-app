...
export default function ModelSelector({ selectedModel, onSelect }: Props) {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div className="absolute top-full right-0 mt-1 w-72 bg-gray-800 border border-gray-700 rounded-lg shadow-xl z-50 overflow-hidden max-h-[70vh] overflow-y-auto">
          {/* Local models */}
